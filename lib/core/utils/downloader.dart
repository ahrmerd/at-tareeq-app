...
class Downloader{
  ...
  //       options: Options(responseType: ResponseType.bytes));
    ...
    Dependancies.http().download(urlPath, savePath, onReceiveProgress: ((count, total) => {
      ...
      if(count>=total){
        ...
        Get.snackbar('Warning', "File already exists please delete downloaded file before redownloading");
    }
  ...
  static Future<String> completeLecturePath(Lecture lecture) async =>'${await getDownloadsPath()}${lectureFilename(lecture)}';
}